 ...
 */
public class ModIOSim implements ModIO {
  // TunerConstants doesn't support separate sim constants, so they are declared locally
  private static final double DRIVE_KP = Constants.Swerve.driveKP;
  private static final double DRIVE_KD = Constants.Swerve.driveKD;
  private static final double DRIVE_KS = Constants.Swerve.driveKS;
  ...
  public ModIOSim() {
     ...
     new DCMotorSim(
         LinearSystemId.createDCMotorSystem(
             DRIVE_GEARBOX,  0.025, Constants.Swerve.chosenModule.driveGearRatio),
         DRIVE_GEARBOX);
    turnSim =
     new DCMotorSim(
         LinearSystemId.createDCMotorSystem(
             TURN_GEARBOX, 0.004, Constants.Swerve.chosenModule.angleGearRatio),
         TURN_GEARBOX);
