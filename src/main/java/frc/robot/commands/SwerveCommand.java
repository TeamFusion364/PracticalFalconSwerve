...
public class SwerveCommand extends Command {
  ...
  public SwerveCommand(
    ...
    rotationController =
        new PIDController(
            Constants.Swerve.HeadingKP, Constants.Swerve.HeadingKI, Constants.Swerve.HeadingKD);
  ...
  public void execute() {
    ...
    switch (States.driveState) {
      case forwardHold:
        ...
        rotationVal =
            rotationController.calculate(
                s_Swerve.getHeading().getRadians(), Units.degreesToRadians(0));
      ...
      case backwardHold:
        ...
        rotationVal =
            rotationController.calculate(
                s_Swerve.getHeading().getRadians(), Units.degreesToRadians(180));
        break;
      case leftHold:
        ...
        rotationVal =
            rotationController.calculate(
                s_Swerve.getHeading().getRadians(), Units.degreesToRadians(90));
        break;
      case rightHold:
        ...
        rotationVal =
            rotationController.calculate(
                s_Swerve.getHeading().getRadians(), Units.degreesToRadians(270));
        break;
      case DynamicLock:
        ...
        rotationVal =
            rotationController.calculate(
                s_Swerve.getHeading().getRadians(), Units.degreesToRadians(dynamicHeading));
        break;
      case standard:
